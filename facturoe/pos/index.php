...
?>
 <div class="col-md-6">
            <label   class="control-label">Aplicar Retención (Dejar vacío si no emplea)</a></label>


    
    

            <select class="form-control input-sm" for="retension" name="retension" id="retension"  >
      
        <option value=""></option>
        <?php
                    
          $query = $con -> query ("SELECT * FROM lista_retenciones");
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Debemos tener en cuenta si estamos vendiendo servicios o productos y en que régimen se encuentra el cliente. compras régimen común, compras persona natural, servicios régimen común, servicios persona natural.</p>
      </div>
...
<div id="myModal7" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Si selecciona "Crédito" la factura ingresara en la lista de cuentas por cobrar.</p>
...
<div id="myModal8" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Puedes seleccionar la fecha en que vence el pago de esta factura (forma de pago crédito).</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
      </div>
          ...
          <div class="col-md-2">
            <label for="comentarios2" class="control-label">
              <style>
...
BOTON AGREGAR
          -->
            <button type="button" class="btn btn-sample" data-toggle="modal" data-target="#myModal">
             <span class=""></span> Agregar Ítems
            </button>
...
<!-- SE CIeRRa FORMULARIO-->
    ...
    <div id="resultados" class='col-md-12'></div><!-- Carga los datos ajax -->
      ...
      <!-- VANTANA MODAL QUE SE ABRE AL PRESIONAR EL BOTON AGREGAR-->
      ...
      <div class="modal fade bs-example-modal-lg" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content">
          ...
          <h4 class="modal-title" id="myModalLabel">Agregar Productos a Cotización</h4>
